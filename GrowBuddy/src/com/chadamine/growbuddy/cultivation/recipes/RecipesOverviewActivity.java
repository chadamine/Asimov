...
public class RecipesOverviewActivity extends ActionBarActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.tab_recipe_details).toUpperCase(l);
			case 1:
				return getString(R.string.tab_ingredients).toUpperCase(l);
			case 2:
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_recipes,
					container, false);
