...
public class NutrientsListActivity extends ActionBarActivity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			getSupportFragmentManager().beginTransaction()
				.add(R.id.nutrientsListContainer, new NutrientsListFragment()).commit();
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.nutrients, menu);
		return true;
	}
